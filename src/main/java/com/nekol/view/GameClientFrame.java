...
import com.nekol.controller.Client;
 ...
 * @author Admin
 */
public class GameClientFrame extends javax.swing.JFrame {
    ...
    public GameClientFrame(User competitor, int room_ID, int isStart, String competitorIP) {
        initComponents();
